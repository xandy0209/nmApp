...
interface GroupOrderDetailProcessProps {
  logs: any[];
}

const GroupOrderDetailProcess: React.FC<GroupOrderDetailProcessProps> = ({ logs }) => {
  return (
    <div className="space-y-4 animate-fade-in">
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <h3 className="font-bold text-gray-800 mb-4 border-l-4 border-[#2ea2e6] pl-2">流程进度</h3>
        <div className="flex justify-between items-center px-2">
          {['下派', '受理', '处理', '回单'].map((step, idx) => (
...
export default GroupOrderDetailProcess;
